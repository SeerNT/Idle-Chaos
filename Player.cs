...
public class Player : MonoBehaviour
{
    ...
    public void UnequipItem(GameItem item, int lvl)
    {
        ...
        if (Reincarnation.permanentsUpgrades[3] > 0)
        {
            if (item.bonusArm >= 0)
            {
                this.armor = (float)Math.Abs(((item.bonusArm + (item.bonusArm * lvlAffection)) * Math.Pow(1.8f, Reincarnation.permanentsUpgrades[3] / 100) - this.abstractARM));
                this.abstractARM = (float)((this.abstractARM - (item.bonusArm + (item.bonusArm * lvlAffection)) * (Math.Pow(1.8f, Reincarnation.permanentsUpgrades[3] / 100))));
            }
            else
            {
                this.armor = (float)(((item.bonusArm - (item.bonusArm * lvlAffection)) * Math.Pow(1.8f, Reincarnation.permanentsUpgrades[3] / 100) - this.abstractARM));
                this.abstractARM = (float)((this.abstractARM - (item.bonusArm - (item.bonusArm * lvlAffection)) * (Math.Pow(1.8f, Reincarnation.permanentsUpgrades[3] / 100))));
            }
        }
        else
        ...
        if (Reincarnation.permanentsUpgrades[4] > 0)
        {
            if (item.bonusPrc >= 0)
            {
                this.pierce = (float)Math.Round(Math.Abs(((item.bonusPrc + (item.bonusPrc * lvlAffection)) * Math.Pow(1.5f, Reincarnation.permanentsUpgrades[4] / 100) - this.abstractPRC)), 2);
                this.abstractPRC = (float)(this.abstractPRC - (item.bonusPrc + (item.bonusPrc * lvlAffection)) * Math.Pow(1.5f, Reincarnation.permanentsUpgrades[4] / 100));
            }
            else
            {
        ...
        if (Reincarnation.permanentsUpgrades[5] > 0)
        {
            if (item.bonusMgcArm >= 0)
            {
                this.magicArmor = (float)Math.Round(Math.Abs((item.bonusMgcArm + (item.bonusMgcArm * lvlAffection)) * Math.Pow(1.6f, Reincarnation.permanentsUpgrades[5] / 100) - this.abstractMARM), 2);
    ...
    public void UseHerb(Herb item)
    {
        ...
        if(Reincarnation.permanentsUpgrades[0] > 0 || Reincarnation.permanentsUpgrades[6] > 0)
        {
            this.physicPower = (float)((this.physicPower + item.bonusPP * (Math.Pow(2, Reincarnation.permanentsUpgrades[0] / 100 + Reincarnation.permanentsUpgrades[6] / 100))));
        }
        else
        {
        ...
        if (Reincarnation.permanentsUpgrades[1] > 0 || Reincarnation.permanentsUpgrades[7] > 0)
        {
            this.maxHp = (float)((this.maxHp + item.bonusHP * (Math.Pow(2, Reincarnation.permanentsUpgrades[1] / 100 + Reincarnation.permanentsUpgrades[7] / 100))));
        }
        else
        {
        ...
        if (Reincarnation.permanentsUpgrades[2] > 0)
        {
            this.magicPower = (float)((this.magicPower + item.bonusMP * (Math.Pow(2, Reincarnation.permanentsUpgrades[2] / 100))));
        }
        else
        {
        ...
        {
            if (this.abstractARM == 0)
                this.abstractARM = (float)((this.armor + item.bonusArm * (Math.Pow(1.8f, Reincarnation.permanentsUpgrades[3] / 100))));
            else
                this.abstractARM = (float)((this.abstractARM + item.bonusArm * (Math.Pow(1.8f, Reincarnation.permanentsUpgrades[3] / 100))));
            this.armor = (float)((this.armor + item.bonusArm * (Math.Pow(1.8f, Reincarnation.permanentsUpgrades[3] / 100))));
        }
        else
        {
            if (this.abstractARM == 0)
                this.abstractARM = this.armor + item.bonusArm;
            else
                this.abstractARM = this.abstractARM + item.bonusArm;
            this.armor = this.armor + item.bonusArm;
        }

        if (Reincarnation.permanentsUpgrades[4] > 0)
        {
            if (this.abstractPRC == 0)
                this.abstractPRC = (float)((this.pierce + item.bonusPrc * (Math.Pow(1.5f, Reincarnation.permanentsUpgrades[4] / 100))));
            else
                this.abstractPRC = (float)((this.abstractPRC + item.bonusPrc * (Math.Pow(1.5f, Reincarnation.permanentsUpgrades[4] / 100))));
            this.pierce = (float)((this.pierce + item.bonusPrc * (Math.Pow(1.5f, Reincarnation.permanentsUpgrades[4] / 100))));
        }
        else
        {
            if (this.abstractPRC == 0)
                this.abstractPRC = this.pierce + item.bonusPrc;
            else
                this.abstractPRC = this.abstractPRC + item.bonusPrc;
            this.pierce = this.pierce + item.bonusPrc;
        }

        if (Reincarnation.permanentsUpgrades[5] > 0)
        {
            if (this.abstractMARM == 0)
                this.abstractMARM = (float)Math.Round(this.magicArmor + item.bonusMgcArm * (Math.Pow(1.6f, Reincarnation.permanentsUpgrades[5] / 100)), 2);
            else
                this.abstractMARM = (float)Math.Round(this.abstractMARM + item.bonusMgcArm * (Math.Pow(1.6f, Reincarnation.permanentsUpgrades[5] / 100)), 2);
            this.magicArmor = (float)Math.Round(this.magicArmor + item.bonusMgcArm * (Math.Pow(1.6f, Reincarnation.permanentsUpgrades[5] / 100)), 2);
        }
        else
        {
            if (this.abstractMARM == 0)
                this.abstractMARM = (float)Math.Round(this.magicArmor + item.bonusMgcArm, 2);
            else
                this.abstractMARM = (float)Math.Round(this.abstractMARM + item.bonusMgcArm, 2);
            this.magicArmor = (float)Math.Round(this.magicArmor + item.bonusMgcArm, 2);
        }

        if (this.abstractLCK == 0)
            this.abstractLCK = (float)Math.Round(this.luck + item.bonusLuck , 2);
        else
            this.abstractLCK = (float)Math.Round(this.abstractLCK + item.bonusLuck, 2);
        this.luck = (float)Math.Round(this.luck + item.bonusLuck, 2);

        this.critDmg = this.critDmg + item.bonusCrit ;

        if (this.abstractAS == 0)
            this.abstractAS = this.attackSpeed - item.bonusAS;
        else
            this.abstractAS = this.abstractAS - item.bonusAS;
        this.attackSpeed = this.attackSpeed - item.bonusAS;
    ...
    public void DisableHerb(Herb item)
    {
        ...
        if (Reincarnation.permanentsUpgrades[3] > 0)
        {
            this.armor = (float)Math.Abs((item.bonusArm * Math.Pow(1.8f, (Reincarnation.permanentsUpgrades[3]) / 100) - this.abstractARM));
            this.abstractARM = (float)((this.abstractARM - item.bonusArm * (Math.Pow(1.8f, (Reincarnation.permanentsUpgrades[3]) / 100))));
        }
        else
        {
        ...
        if (Reincarnation.permanentsUpgrades[4] > 0)
        {
            this.pierce = (float)Math.Round(Math.Abs(item.bonusPrc * Math.Pow(1.5f, (Reincarnation.permanentsUpgrades[4]) / 100) - this.abstractPRC), 2);
            this.abstractPRC = (float)(this.abstractPRC - item.bonusPrc * Math.Pow(1.5f, (Reincarnation.permanentsUpgrades[4]) / 100));
        }
        else
        {
        ...
        if (Reincarnation.permanentsUpgrades[5] > 0)
        {
            this.magicArmor = (float)Math.Round(Math.Abs(item.bonusMgcArm * Math.Pow(1.6f, (Reincarnation.permanentsUpgrades[5]) / 100) - this.abstractMARM), 2);
            this.abstractMARM = (float)(this.abstractMARM - item.bonusMgcArm * Math.Pow(1.6f, (Reincarnation.permanentsUpgrades[5]) / 100));
        }
        else
        {
            this.magicArmor = (float)Math.Round(Math.Abs(item.bonusMgcArm - this.abstractMARM), 2);
